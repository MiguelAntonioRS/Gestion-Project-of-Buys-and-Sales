 ...
 */
public class FrmSupplierView extends javax.swing.JFrame {
    ...
    private void tblListMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblListMousePressed
        if (evt.getClickCount()==2) {
            ...
            FrmBuys.txtIdSupplier.setText(cod);
            FrmBuys.txtSupplier.setText(firstName);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmSupplierView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmSupplierView().setVisible(true);
            }
        });
    }
