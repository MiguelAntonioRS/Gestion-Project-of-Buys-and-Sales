 ...
 */
public class FrmProductView extends javax.swing.JFrame {
    ...
    void see(String buscar) {
        try {

            DefaultTableModel modelo;
            NProduct func = new NProduct();
            modelo = func.showA(buscar);
    ...
    private void tblListMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblListMousePressed
        ...
        if (option == 1) {
            if (evt.getClickCount() == 2) {
                ...
                product = tblList.getValueAt(row, 2).toString();
                price = tblList.getValueAt(row, 5).toString();

                FrmBuys.txtIdProduct.setText(cod);
                FrmBuys.txtProduct.setText(product);
                FrmBuys.txtBuysPrice.setText(price);
                this.dispose();
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmProductView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmProductView().setVisible(true);
            }
        });
    }
